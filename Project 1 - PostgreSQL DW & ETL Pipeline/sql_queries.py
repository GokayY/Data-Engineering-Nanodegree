...
user_table_create = ("CREATE TABLE IF NOT EXISTS users (user_id int, first_name varchar, last_name varchar, gender char,user_agent varchar)")
...
time_table_create = ("CREATE TABLE IF NOT EXISTS Time (timestamp varchar, hour int, day int, weekOfYear int, month int, year int, weekday int)")
...
user_table_insert = ("INSERT INTO users (user_id, first_name, last_name, gender, user_agent) \
                          VALUES (%s, %s, %s, %s, %s)")
